...
The average number of woody tree recruits per ha per year on bci is 110 individuals. Assume that 90 percent of that is late PFTs.




Pick up: find out why the light dependent recruitment (early PFT) relationship plateaus around 30 percent light when growth rates continue to go up.
...
The seedling pool is getting too large by about an order of magnitude
